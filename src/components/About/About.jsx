...
const values = [
  { name: 'Professionalism', desc: 'We hold ourselves to a high standard in every interaction and deliverable.', icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="2" y="7" width="20" height="14" rx="2"/><path d="M16 7V5a2 2 0 00-2-2h-4a2 2 0 00-2 2v2"/></svg> },
  { name: 'Excellence', desc: 'Good enough is never the goal. We pursue the best outcome on every brief.', icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M12 2L15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2z"/></svg> },
  { name: 'Integrity', desc: 'Honest pricing, and clear communication.', icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg> },
  { name: 'Innovation', desc: 'We bring fresh thinking to every project, however routine it may seem.', icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z"/></svg> },
  { name: 'Reliability', desc: 'When we commit to something, we follow through.', icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M20 6L9 17l-5-5"/></svg> },
]
      ...
      <div className="container">
        <div className="about-grid">
          <div>
            ...
            <p className="about-text" data-reveal>Freetown Press was founded with one goal: to provide businesses and organisations of all kinds with dependable, high-quality corporate solutions under one roof.</p>
