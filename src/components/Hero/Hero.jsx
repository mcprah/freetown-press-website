        ...
        <div className="hero-grid">
          <div>
            ...
            <div className="hero-buttons">
              ...
              <a href="/services" className="btn btn-outline">Explore Services <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" style={{ width: 14, height: 14 }}><path d="M5 12h14M12 5l7 7-7 7"/></svg></a>
            </div>
          </div>
        </div>
      </div>
